<div id="circularMenu" class="circular-menu z-50 sm:block lg:hidden active">
  ...
  <menu class="items-wrapper">
    ...
    <a href="#technical" class="menu-item">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        width="1.2rem"
...
<style>
  ...
  .circular-menu:after {
    ...
    right: 0;
    z-index: -2;
    background: rgba(66, 58, 183, 0.37);
  ...
  .menu-item {
    ...
    flex-direction: row;
    background: rgba(58, 71, 183, 0.37);
