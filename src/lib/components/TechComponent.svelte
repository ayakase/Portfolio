...
>
    <div
        class=" grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10"
    >
        <div
                        ...
                        <li class="flex gap-x-3">
                            ...
                            <span class="text-gray-100"
                                ><strong class="font-semibold"
                                    >Front-end:</strong
                                > Vue 3, Nuxt 3, Pinia, Vuetify, Svelte, ThreeJS,
                                Bootstrap, BulmaCSS, TailwindCSS, AceternityUI</span
                            >
                        </li>
                        <li class="flex gap-x-3">
                            <svg
                            ...
                            <span class="text-gray-100"
                                ><strong class="font-semibold">Back-end:</strong
                                > NodeJS, ExpressJS, Flask, Supabase, Firebase, Ruby
                                on Rails, Socket.IO</span
                            >
                        </li>
                        <li class="flex gap-x-3">
                            <svg
                            ...
                            <span class="text-gray-100"
                                ><strong class="font-semibold"
                                    >Database:
                                </strong> MySQL, MongoDB, Firestore 10</span
                            >
                        </li>
                        <li class="flex gap-x-3">
                            <svg
                            ...
                            <span class="text-gray-100"
                                ><strong class="font-semibold">Cloud: </strong> AWS
                                EC2, Cloudinary</span
                            >
                        </li>
                        <li class="flex gap-x-3">
                            ...
                            <span class="text-gray-100"
                                ><strong class="font-semibold">Other </strong> Git,
                                Github, Linux, Bash, Vite
                            </span>
                        </li>
                    </ul>
                    <p class="mt-8">
