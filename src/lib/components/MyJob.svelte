<script lang="ts">
    ...
    onMount(() => {
        if (window.innerWidth > 768) {
            ...
            let mouse: Matter.Mouse = Mouse.create(render.canvas),
            ...
            // Correct way to remove mouse wheel event listeners
            ...
            Events.on(
                mouseConstraint,
                "mouseup",
                function (event: Matter.IEvent<Matter.MouseConstraint>) {
