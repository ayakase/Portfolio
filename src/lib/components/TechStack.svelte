  ...
  <ul role="list" class=" flex flex-col h-full justify-around text-gray-600">
    <li class="flex gap-x-2">
      ...
      <span class="text-gray-100 lg:text-xl text-base"
        ><strong class="font-semibold">Front-end: </strong> Vue 3, Nuxt 3, Pinia,
        Vuetify, Svelte, ThreeJS, Bootstrap, TailwindCSS, AceternityUI</span
      >
    </li>
    <li class="flex gap-x-2">
      <svg
    ...
    <li class="flex gap-x-2">
      ...
      <span class="text-gray-100 lg:text-xl text-base"
        ><strong class="font-semibold">Cloud: </strong> AWS EC2, AWS S3, AWS Lamda
        Function, Cloudinary</span
      >
    </li>
    <li class="flex gap-x-2">
      <svg
    ...
    <li>
      <p class="mt-1">
        VueJS and NodeJS are the two skills that I am most confident about, I
        love to discover and learn about other tech stacks as well.
      </p>
    </li>
  </ul>
</div>
